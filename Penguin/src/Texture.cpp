	...
	: m_textureID{ 0 }, m_width{ 0 }, m_height{ 0 }, m_bitsPerPixel{ 0 }, m_buffer{ nullptr }
{
	...
	// The maximum anisotropy level can be queried with: glGetFloatv(GL_MAX_TEXTURE_MAX_ANISOTROPY_EXT, &maxAniso);
	glSamplerParameterf(m_samplerID, GL_TEXTURE_MAX_ANISOTROPY_EXT, 4.0f);
